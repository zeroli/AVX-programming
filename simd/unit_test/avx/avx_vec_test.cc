...
TEST(vec_avx, test_types)
{
    ...
    ut::test_type<simd::vi64x4_t,  4,  1, 4, simd::AVX>();
    ut::test_type<simd::vi64x8_t,  8,  2, 4, simd::AVX>();

    ut::test_type<simd::vu64x2_t,  2,  1, 2, simd::SSE>();
    ut::test_type<simd::vu64x4_t,  4,  1, 4, simd::AVX>();
    ut::test_type<simd::vu64x8_t,  8,  2, 4, simd::AVX>();
