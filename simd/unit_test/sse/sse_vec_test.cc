...
TEST(vec_sse, test_types)
{
    ...
    TEST_VEC_TYPE(simd::vcf32x8_t,  8,  2, 4, simd::Generic);
    TEST_VEC_TYPE(simd::vcf32x16_t, 16, 4, 4, simd::Generic);

    TEST_VEC_TYPE(simd::vcf64x2_t, 2, 1, 2, simd::Generic);
    TEST_VEC_TYPE(simd::vcf64x4_t, 4, 2, 2, simd::Generic);
    TEST_VEC_TYPE(simd::vcf64x8_t, 8, 4, 2, simd::Generic);
}
