...
void permute_f32()
{
    ...
    // 输出256bits，8个数，前4个数从输入的前4个数中选择，选择4个数，只需要2bits就够
    // 控制选择输入，只有8bits，代表4个选择
    // 这4个选择，被重复使用在前4个数和后4个数的选择中
    std::cout << "permute at " << "00(0) 01(1) 11(3) 01(1) 00(0) 01(1) 11(3) 01(1)" << "\n";
